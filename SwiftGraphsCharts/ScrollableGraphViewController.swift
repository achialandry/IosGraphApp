...
//  SwiftGraphsCharts
//
//  Created by Landry Achia Ndong on 2018-07-20.
...
class ScrollableGraphViewController: UIViewController, ScrollableGraphViewDataSource {
    ...
    lazy var xAxisLabels: [String] =  self.generateSequentialLabels(self.numberOfDataItems, text: "Lab")
